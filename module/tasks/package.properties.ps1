...
# Synopsis: The URL to use when publishing packages to the Python repository. e.g. https://pkgs.dev.azure.com/myOrg/Project/_packaging/myfeed/pypi/upload
$PythonPackageRepositoryUrl = property ZF_BUILD_PYTHON_PUBLISH_REPOSITORY_URL ""

# Synopsis: Set this to override the default pre-release tag generated by GitVersion.
$PythonPackagePreReleaseTag = property ZF_BUILD_PYTHON_PUBLISH_PRERELEASE_TAG ""

# Synopsis: The wildcard pattern used to select the built Python packages for publishing.
